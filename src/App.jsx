  ...
  return (
    <div className="antialiased min-h-screen flex bg-[#F8FAFC] text-gray-800">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8 max-w-7xl w-full mx-auto flex flex-col justify-between">
          ...
          {/* 🏢 BRAND NEW BRANDING COPYRIGHT FOOTER BAR */}
          <footer className="w-full text-center pt-12 pb-2 text-[11px] font-bold text-gray-400 uppercase tracking-wider select-none">
            © {new Date().getFullYear()} studyniq company. all rights reserved.
          </footer>
